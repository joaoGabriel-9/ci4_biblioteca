<div class="container p-5">
    ...
    <input value='<?=$emprestimo['id_livro']?>'class='form-control' type="hidden" name='id_livro_antigo'>
    <?php
    ...
    <div class="row p-2">
        ...
        <div class="col-10">
            <input value='<?=$emprestimo['data_prazo']?>'class='form-control' type="int" id='data_prazo' name='data_prazo'>
        </div>
    </div>
    <div class="row p-2">
                <?php
    ...
    <input value='<?=$emprestimo['id']?>'class='form-control' type="hidden" id='id' name='id'>
    <input value='<?=$emprestimo['id_livro']?>'class='form-control' type="hidden" name='id_livro'>
